namespace IF_ESEIF_ELSE_3
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Kas soovid saada programeerijaks ? (jah/ei)");
                string Vastus = "";
            ...
            {
                Console.WriteLine("mitu rage comicsit täna oled redditi lugemise ajal leidnud ?");
            }
            ...
            */
            ...
            /*
                ...
                Console.WriteLine("Kas töötad või mitte ? (jah/ei)");
                string Vastus2 = "";
                Vastus2 = Console.ReadLine();
                ...
                {
                    Console.WriteLine("Kahju, miks siis töökohta ei otsi ?");
                    string Vastus3 = Console.ReadLine();
                    if (Vastus3 == "otsin")
                    {
                        Console.WriteLine("Tubli, loodan et leiad töö varsti c:");
                    }
                    else
                    {
                        Console.WriteLine("See võib olla hea põhjus aga ma ei ole AI ma ei tea");
                    }
                }
                else
                {
                    Console.WriteLine("Pole vastuse valikutes");
                }
